/*
An articulation point(or cut vertex) is a node in a graph whose removal, along with its connected edges, inrcresed
the total number of disconnecttedd pieces(components) in the graph.
*/
